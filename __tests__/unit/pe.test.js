...
describe('compilePE — freeform block', () => {
  test('renders text field', () => {
    ...
    const result = compilePE(blocks, registry, templates, branchPath, null);
...
describe('compilePE — template block', () => {
  ...
  test('explicit template overrides type for lookup', () => {
    ...
    const result = compilePE(blocks, registry, overrideTemplates, branchPath, null);
  ...
  test('fields: {} is safe when no fields provided', () => {
    ...
    const result = compilePE(blocks, registry, noFieldTemplate, branchPath, null);
